...
```
    ...
    ## Joining with `by = join_by(dumpster, month, year, date, weight_tons,
    ## volume_cubic_yards, plastic_bottles, polystyrene, cigarette_butts,
    ## plastic_bags, homes_powered, name)`
...
Specifically, the cleaned “Mr. Trash Wheel” data set contains 548
observations of 15 variables from May, 2014 to August, 2022. The cleaned
“Professor Trash Wheel” data set contains 95 observations of 14
variables from January, 2017 to August, 2022. the cleaned “Gwynnda Trash
Wheel” data set contains 108 observations of 12 variables from July,
2021 to August, 2022.  
For the resulting dataset, it contains 751 observations of 15 variables,
...
collected by Professor Trash Wheel is 192.62 and the total number of
...
After cleaning, the data set contains 2415 observations of 3 variables.
